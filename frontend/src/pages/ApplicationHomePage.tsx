...
import { Breadcrumbs , DragAndDropArea , Button } from '../components/ui';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 lg:p-6 shadow-sm">
            <h3 className="font-semibold text-gray-900 mb-4 lg:mb-6">Primary Applicant</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-4 lg:p-6 shadow-sm flex flex-col justify-between">
            <div>
        ...
        <div className="mb-8">
          <DragAndDropArea onDropFiles={handleDropFiles} className="border-2 border-dashed border-gray-300 rounded-xl p-4 lg:p-6 text-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer w-full">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4 lg:mb-6">
              <h3 className="font-semibold text-gray-900 mb-2 lg:mb-0">Documents</h3>
            ...
            <div className="flex flex-col items-center justify-center py-6 lg:py-8">
              ...
              <p className="text-gray-600 mb-4 text-sm lg:text-base">Supported formats: PDF, Excel, Word, Images (JPG, PNG)</p>
              <Button 
                variant="primary" 
